...
ActiveRecord::Schema.define(version: 2020_09_24_234902) do
  ...
  create_table "product_category_settings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.bigint "product_id", null: false, comment: "Product.id"
    t.bigint "category_setting_item_id", null: false, comment: "CategorySettingItem.id"
